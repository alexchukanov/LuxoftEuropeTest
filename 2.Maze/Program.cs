//You are given a map of square room, some of the tiles of this room are blocked//You are standing at starting tile. 
//You can step in four directions (top, right, bottom, left), one tile per step//Write a code that returns the minimum number
//of steps required to get from your starting tile to the specific target tile
////Input format:
//First line contains a size of the room N  (3 <= N <= 80)//Next N lines contain map of the room where # means empty tile, 
//* means blocked tile, 0 means starting tile and 1 means target tile
////Output format:
